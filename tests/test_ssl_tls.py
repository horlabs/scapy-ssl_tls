...
class TestTLSRecord(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.stacked_handshake = tls.TLS(bytes(stacked_handshake_layers))
            # bytes(tls.TLSRecord(content_type="handshake") / "".join(list(map(str, stacked_handshake_layers)))))
...
class TestTLSDissector(unittest.TestCase):
    ...
    def setUp(self):
        self.payload = binascii.unhexlify(
            b"")
        unittest.TestCase.setUp(self)
    ...
    def _static_tls_handshake(self):
        ...
        server_hello = binascii.unhexlify(
            b"")
    ...
    def test_stacked_tls_records_are_correctly_dissected_from_bytes(self):
        ...
        self.assertEqual(pkt[0][tls.TLSHandshake].session_id,
                         binascii.unhexlify(b"2de1c20c707ba9b083282d2eba3d95bdfb5847eb9241f252173a04c9f990d508"))
    ...
    def test_encrypted_layer_is_decrypted_if_required(self):
        ...
        server_finished = binascii.unhexlify(
            b"14030100010116030100305b0241932c63c0cf1e4955e0cc65f751a3921fe8227c2bae045c66be327f7e68a39dc163b382c90d2caaf197ba0563a7")
        ...
        app_response = binascii.unhexlify(
            b"")
...
class TestTLSDecryptablePacket(unittest.TestCase):
    ...
    def test_streaming_mac_and_padding_are_added_if_session_context_is_provided(self):
        data = b"A" * 2 + b"B" * MD5.digest_size
        tls_ctx = tlsc.TLSSessionCtx()
    ...
    def test_cbc_mac_and_padding_are_added_if_session_context_is_provided(self):
        data = b"A" * 2 + b"B" * SHA.digest_size + b"\x03" * 4
        tls_ctx = tlsc.TLSSessionCtx()
        tls_ctx.sec_params = tlsc.TLSSecurityParameters.from_pre_master_secret(
    ...
    def test_explicit_iv_is_added_for_tls_1_1_if_session_context_is_provided(self):
        data = b"C" * AES.block_size + b"A" * 2 + b"B" * SHA.digest_size + b"\x03" * 4
        tls_ctx = tlsc.TLSSessionCtx()
...
class TestTLSClientHello(unittest.TestCase):
    ...
    def test_dissect_client_hello_extensions(self):
        ...
        self.assertEquals(extensions.pop()[tls.TLSExtRenegotiationInfo].data, b"myreneginfo")
        self.assertEquals(extensions.pop()[tls.TLSExtSessionTicketTLS].data, b"myticket")
        ...
        self.assertEquals(extensions.pop()[tls.TLSExtALPN].protocol_name_list[0].data, b"http/2.0")
        ext = extensions.pop()
        self.assertEquals(ext[tls.TLSExtALPN].protocol_name_list[1].data, b"http/1.0")
        self.assertEquals(ext[tls.TLSExtALPN].protocol_name_list[0].data, b"http/1.1")
        ext = extensions.pop()
        self.assertEquals(ext[tls.TLSExtServerNameIndication].server_names[1].data, b"github.com")
        self.assertEquals(ext[tls.TLSExtServerNameIndication].server_names[0].data, b"www.github.com")
...
class TestTLSPlaintext(unittest.TestCase):
    ...
    def test_built_plaintext_includes_mac_and_padding_if_not_empty(self):
        ...
        self.assertEqual(data + mac + padding + bytes([len(padding)]), bytes(plaintext))
...
-----END PRIVATE KEY-----
    ...
    def test_format_of_tls_finished_is_as_specified_in_rfc(self):
        def encrypt(crypto_container):
            self.assertEqual(crypto_container.crypto_data.data, b"\x14\x00\x00\x0c" + self.tls_ctx.get_verify_data())
